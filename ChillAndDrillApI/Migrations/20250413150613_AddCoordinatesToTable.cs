    ...
    public partial class AddCoordinatesToTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("menu_categories_pkey", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("table_reservations_pkey", x => x.id);
                    table.ForeignKey(
                        name: "table_reservations_table_id_fkey",
                        column: x => x.table_id,
                        principalTable: "tables",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "table_reservations_user_id_fkey",
                        column: x => x.user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "menu_categories_name_key",
                table: "menu_categories",
                column: "name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "menu_categories_slug_key",
                table: "menu_categories",
                column: "slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_table_reservations_user_id",
                table: "table_reservations",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "tables_name_key",
                table: "tables",
                column: "name",
                unique: true);
